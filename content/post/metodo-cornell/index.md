...
- **Si ascolta passivamente**, ed altrettanto passivamente trasferiscono sul quaderno quello che si ascolta.
...
- Se poi,mentre ascolta, ci si preoccupa soprattutto di trascrivere tutto, ciò non fa altro che aggiungere inefficienza a inefficienza.

  - Non rimane tempo per pensare, e quindi scompare ogni coinvolgimento intellettuale rispetto a quello che senti
...
- Sotto ad essi, scrivi gli appunti veri e propri, utilizzando:
	...
	- `Caratteri`: usando *corsivo*, **grassetto**, MAIUSCOLO, minuscolo, etc.
...
2. **Dopo la lezione**, costringe a *rielaborare il materiale* in maniera **analitica e sintetica**, e permette poi il **ripasso a tre livelli** di dettaglio differenti:
